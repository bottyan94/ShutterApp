...
mongoimport --host $MONGO_HOST_IP --db shutter --collection customers customers.json
...
mongoimport --host $MONGO_HOST_IP --db shutter --collection invoice invoice.json
